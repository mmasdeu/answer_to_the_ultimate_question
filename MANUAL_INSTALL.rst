...
2) Put your newly created package in it::
     ...
     $ cd answer_to_the_ultimate_question
     $ git init
     $ git add .
     $ git commit -m "first commit"
     $ git remote add origin https://github.com/mmasdeu/answer_to_the_ultimate_question.git
     $ git remote -v
...
#) Enable automatic deployment of documentation to GitHub pages using Travis CI.
   ...
   * First enable Travis CI integration of your GitHub-hosted project. This is done by signing-in into https://travis-ci.org/profile/mmasdeu and pushing the switch corresponding to answer_to_the_ultimate_question.
   ...
   * If you don't already have GitHub pages for your project: Create and
     ...
     Then commit it and push it to GitHub::
       ...
       $ git clone --single-branch --depth 1 https://github.com/mmasdeu/answer_to_the_ultimate_question.git gh-pages
       $ cd gh-pages
   ...
   * The deployed documentation will be available at:
     https://mmasdeu.github.io/answer_to_the_ultimate_question/
     ...
     https://mmasdeu.github.io/answer_to_the_ultimate_question/doc/html/
