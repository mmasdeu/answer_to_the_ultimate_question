...
git remote add origin https://github.com/mmasdeu/answer_to_the_ultimate_question.git >> install.log
...
git clone --single-branch --depth 1 https://github.com/mmasdeu/answer_to_the_ultimate_question.git gh-pages >> install.log
cd gh-pages
