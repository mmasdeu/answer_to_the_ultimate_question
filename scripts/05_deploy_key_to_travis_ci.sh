...
travis login -u mmasdeu
travis encrypt-file .travis_ci_gh_pages_deploy_key --add before_script -r mmasdeu/answer_to_the_ultimate_question
travis enable -r mmasdeu/answer_to_the_ultimate_question
echo "Done!"
